...
export const sidebarItems = [
    ...
    {
        name: 'Users',
        icon: ({ isActive }: { isActive: boolean }) => <FaUsers size={32} color={isActive ? '#000000' : '#8b8b8b'} />,
        link: '/users',
    },
    {
        name: 'Live Reports',
        icon: ({ isActive }: { isActive: boolean }) => <HiOutlineQueueList size={32} color={isActive ? '#000000' : '#8b8b8b'} />,
        link: '/queue',
    },
];
            ...
            <div className='flex flex-col items-center w-16 border-r border-t px-2 py-6 w-16 border-[#cdcdcd] h-screen'>
                ...
                <div className='flex items-center flex-col space-y-6 mb-[80px]'>
                    <Link href={'/profile'} key={'profile'} className='flex items-center space-x-3'>
                        <svg
                            fill={path === '/profile' ? '#000000' : '#8b8b8b'}
                            width='32px'
                            height='32px'
                            viewBox='0 0 24 24'
