...
export default function NewCampaign({ action, buttonText, title, description }: any) {
    return (
        <div className='flex flex-col gap-5 items-center justify-center w-96 h-[500px] m-auto'>
            ...
            <div className='text-center text-sm text-[#8b8b8b]'>{description}</div>
            <button onClick={action} className='cursor-pointer bg-black flex items-center py-3 rounded-lg px-3 sm:px-6 text-white gap-2'>
