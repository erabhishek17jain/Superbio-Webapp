...
import productHomepage from '@/public/contact/homepage.png';
...
export const ContactUs = () => {
    ...
    return (
        <div id='contact-us' className='flex w-full items-center overflow-hidden px-6 sm:px-12 md:px-16 lg:px-24'>
            <section ref={ref} className='flex w-full flex-col-reverse items-center justify-between overflow-hidden sm:flex-row'>
