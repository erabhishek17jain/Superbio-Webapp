...
export default function ResetPassword() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col mt-6">
        <button onClick={handleResetPassword} className="flex capitalize items-center font-semibold justify-center text-white text-xs p-3 px-5 border bg-black rounded-lg">
