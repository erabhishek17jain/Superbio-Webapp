...
export default function FilterUi(props: FilterUiProps) {
    ...
    const selectFilter = (checked: boolean, key: string, value: string) => {
        console.log('selectFilter -> ', checked, key, value);
        let filter = { ...filters };
        console.log('currentFilterValues', filter);
        ...
        console.log('filterKeys -> ', filterKeys, 'filterValues -> ', filterValues);
                                                        ...
                                                        item._id && (
                                                            <li key={item._id.$oid} className={`flex items-center gap-3 pl-2 py-2 border-stroke`}>
                                                                <input
                                                                    ...
                                                                    onChange={(e: any) =>
                                                                        selectFilter(e?.currentTarget?.checked, key.key, item._id.$oid)
                                                                    }
                                                                />
