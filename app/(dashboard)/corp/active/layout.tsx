...
export default function RootLayout({ children }: { children: ReactNode }) {
    ...
    const [pathUrls, setPathUrls] = useState(paths.split('/').filter((item: string) => !(item === '' || item === 'corp' || item === 'active')));
                                ...
                                <div className='hidden sm:flex gap-2'>
                                    <div className='flex'>
                                        ...
                                        <div
                                            ...
                                            className='hidden sm:flex text-[#8b8b8b] cursor-pointer items-center space-x-3 mt-[2px]'>
                                            <span className='ml-3 capitalize'>Advance analytics</span>
                                            <ChevronRightIcon color='#8b8b8b' size={22} />
                                        </div>
                                        {!isCreateReport &&
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            if (active) {
                                                                fetchMore();
                                                                router.push(`/corp/${component}`);
                                                                setPathUrls(`/corp/${component}`.split('/'));
                                                            }
                                                        }}
