...
import CorpNetworkService from '@/services/corp.service';
...
import FilterUi from '../../../../../../components/shared-components/corp/FilterUi';
import GenerateReport from '../../../../../../components/shared-components/corp/GenerateReport';
import FilterAndSorting from '../../../../../../components/shared-components/corp/FilterAndSorting';
import Reporting from '../../../../../../components/shared-components/corp/Reporting';
import AnalyticsSummary from '@/components/shared-components/corp/AnalyticsSummary';
...
export default function ProfileReporting({ searchParams, params }: { searchParams: SearchParams; params: Params }) {
    ...
    const initialLoadInstagramCampData = async (query: any, platforms: any) => {
        ...
        const twitterResp: any =
            !platforms.isInstagram && (await CorpNetworkService.instance.getTwProfileReportingData(params.campaignId, clearFilters(queryInitial)));

        CorpNetworkService.instance
    ...
    const initialLoadTwitterCampData = (query: any, platforms: any) => {
        CorpNetworkService.instance.getTwProfileReportingData(params.campaignId, clearFilters(query)).then((resp) => {
