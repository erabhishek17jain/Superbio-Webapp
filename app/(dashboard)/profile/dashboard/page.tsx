                        ...
                        {activeCampaign && activeCampaign.data?.length > 0 && (
                            <div className='flex flex-col w-full mb-4 sm:mb-10'>
                                <div className='flex w-full justify-between mb-3 sm:mb-5'>
                                    ...
                                    <Link href={`/profile/active`} className='text-[#8b8b8b] cursor-pointer text-base font-semibold'>
                                        See More
                                    </Link>
                                </div>
                        ...
                        {sharedCampaign && sharedCampaign.data?.length > 0 && (
                            <div className='flex flex-col w-full mb-4 sm:mb-10'>
                                <div className='flex w-full justify-between mb-3 sm:mb-5'>
                                    ...
                                    <Link href={'/profile/shared'} className='text-[#8b8b8b] cursor-pointer text-base font-semibold'>
                                        See More
                                    </Link>
                                </div>
